...
// CreateManage 创建问卷权限
func (d *Dao) CreateManage(ctx context.Context, id int, surveyID int64) error {
	err := d.orm.WithContext(ctx).Create(&model.Manage{UserID: id, SurveyID: surveyID}).Error
	return err
}

// DeleteManage 删除问卷权限
func (d *Dao) DeleteManage(ctx context.Context, id int, surveyID int64) error {
...
func (d *Dao) DeleteManageBySurveyID(ctx context.Context, surveyID int64) error {
	err := d.orm.WithContext(ctx).Where("survey_id = ?", surveyID).Delete(&model.Manage{}).Error
	return err
}

// CheckManage 检查问卷权限
func (d *Dao) CheckManage(ctx context.Context, id int, surveyID int64) error {
...
func (d *Dao) GetManageByUIDAndSID(ctx context.Context, uid int, sid int64) (*model.Manage, error) {
	var manage model.Manage
